...
class Welcome extends CI_Controller {
	...
	public function check()
	{
		...
		if(!empty($_POST['stripeToken']))
		{
			...
			//set api key
			$stripe = array(
			  "secret_key"      => "sk_test_51J64ZtLqhECGAqjhVQaBg8ZYPAw2JBHO1q0auEBjdIkAs86ICIHMM9oF9u7Y7bIAzg6QEN6bDPlnCOznUbHWIGfP00y5vCEIiA",
			  "publishable_key" => "pk_test_51J64ZtLqhECGAqjhbQHvaObthKOqIzMMPidlUaEi1bmogZpN9lSfgmQAFN4JXbLhXEwR9Vijcj6gS0eRALsecBEH00wmff1B55"
			);
